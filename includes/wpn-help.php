    ...
    <table width="1004" class="form-table">
        ...
        <tr>
            <td colspan="2" class="help">
                ...
                <ol>
                    <li>Zaloguj się do panelu Nakiedy: <a href="https://www.nakiedy.pl/zaloguj.html" target="_blank">Zaloguj się</a> <br>lub<br> jeśli nie masz konta <a href="https://www.nakiedy.pl/zarejestruj.html" target="_blank">Zarejestruj się</a></li>
                    <li><p>Przejdź do zakładki <a href="https://app.nakiedy.pl/settings/services" target="_blank">moja firma</a></p><img src="<?php echo plugins_url('../images/moja_firma.jpg', __FILE__);?>" /></li>
                    <li><p>Wybierz <a href="https://app.nakiedy.pl/settings/general" target="_blank">Ustawienia>System</a> z lewego menu</p><img src="<?php echo plugins_url('../images/ustawienia.gif', __FILE__);?>" /></li>
